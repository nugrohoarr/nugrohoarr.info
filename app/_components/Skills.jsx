...
import { SiExpress, SiGithubactions, SiGooglecloud, SiJavascript, SiMongodb, SiNestjs, SiNginx, SiServerless, SiTypescript } from "react-icons/si";
import { FaAws, FaGithub, FaGitlab, FaHtml5, FaLinux, FaServer } from "react-icons/fa";
import { IoLogoCss3 } from "react-icons/io";
import { SiTailwindcss } from "react-icons/si";
import { DiGithub, DiGoogleCloudPlatform, DiMysql, DiNginx, DiNodejs, DiNodejsSmall, DiPostgresql, DiReact } from "react-icons/di";
        ...
        <div className="py-10 -mt-5 mb-10 px-5">
            <div className="flex gap-3 flex-wrap items-center justify-center rounded-md max-w-3xl mx-auto">
                <div className="relative group  h-24 w-24 grid place-items-center rounded-md border active:bg-secondary md:hover:bg-secondary transition cursor-pointer hover:scale-95">
                    ...
                    <span className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out text-xs text-black mt-16">
                        JavaScript
                    </span>
                </div>
                <div className="relative group h-24 w-24 grid place-items-center rounded-md border active:bg-secondary md:hover:bg-secondary transition cursor-pointer hover:scale-95">
                ...
                <div className="relative group h-24 w-24 grid place-items-center rounded-md border active:bg-secondary md:hover:bg-secondary transition cursor-pointer hover:scale-95">
                    <SiGooglecloud className="h-10 w-10" />
                    <span className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out text-xs text-black mt-16">
                        GCP
                    </span>
                </div>
                ...
                <div className="relative group h-24 w-24 grid place-items-center rounded-md border active:bg-secondary md:hover:bg-secondary transition cursor-pointer hover:scale-95">
                    <DiPostgresql className="h-10 w-10" />
                    <span className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out text-xs text-black mt-16">
                        PostgreSQL
                    </span>
                </div>
                <div className="relative group h-24 w-24 grid place-items-center rounded-md border active:bg-secondary md:hover:bg-secondary transition cursor-pointer hover:scale-95">
                    <DiMysql className="h-10 w-10" />
                    <span className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out text-xs text-black mt-16">
                        MySql
                    </span>
                </div>
